...
const SPREADSHEET_ID = '1lazIF0iQt1JZdVO8UidMtMVrV3Tl5iXz5yDOZpyV39k';
...
function handleRequest(e) {
    try {
        ...
        var allowedSheets = ['Data Laptop', 'DATA PEGAWAI', 'Data Peminjaman', 'Data Pengembalian'];
...
function getAllSheets() {
    var ss = SpreadsheetApp.openById(SPREADSHEET_ID);
    var sheets = ['Data Laptop', 'DATA PEGAWAI', 'Data Peminjaman', 'Data Pengembalian'];
    var result = {
        success: true,
